...
void main() async {
  ...
  characters.forEach((character) {
    print('ID: ${character.id}, Name: ${character.name}, Status: ${character.status}');
  });

  print('\nLocations:');
  locations.forEach((location) {
    print('ID: ${location.id}, Name: ${location.name}, Type: ${location.type}');
  });

  print('\nEpisodes:');
  episodes.forEach((episode) {
    print('ID: ${episode.id}, Name: ${episode.name}, Air Date: ${episode.airDate}');
  });
}
